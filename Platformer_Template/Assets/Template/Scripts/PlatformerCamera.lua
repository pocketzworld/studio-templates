...
function ZoomCamera(evt)
    -- Calculate the new zoom level based on the initial zoom and the pinch scale
    local newZoom = initialZoomOfPinch * evt.scale
    zoom = Mathf.Clamp(newZoom, zoomMin, zoomMax)
end

-- Removed the ResetZoomScale function as it's not needed anymore
